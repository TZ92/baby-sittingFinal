...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/map/map')) {
            // pidev_map_homepage
            if ($pathinfo === '/map/map') {
                return array (  '_controller' => 'Pidev\\MapBundle\\Controller\\DefaultController::indexAction',  '_route' => 'pidev_map_homepage',);
            }

            // pidev_map_map
            if ($pathinfo === '/map/mapdynamique') {
                return array (  '_controller' => 'Pidev\\MapBundle\\Controller\\DefaultController::MapNadineAction',  '_route' => 'pidev_map_map',);
            }

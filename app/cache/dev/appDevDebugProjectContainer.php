...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'baby-sitting', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_e8dde8b37ed82792c35cf1b4dc5ae0c3');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_e8dde8b37ed82792c35cf1b4dc5ae0c3');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_e8dde8b37ed82792c35cf1b4dc5ae0c3');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Pidev\\FrontBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Pidev\\backBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Pidev\\UserBundle\\Entity')));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Pidev\\FrontBundle\\Entity');
        $f->addDriver($e, 'Pidev\\backBundle\\Entity');
        $f->addDriver($e, 'Pidev\\UserBundle\\Entity');
        $f->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\Resources\\config\\doctrine\\model') => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('PidevFrontBundle' => 'Pidev\\FrontBundle\\Entity', 'PidevbackBundle' => 'Pidev\\backBundle\\Entity', 'PidevUserBundle' => 'Pidev\\UserBundle\\Entity'));
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Pidev\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Pidev\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Pidev\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Pidev\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Pidev\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/baby/');
        ...
        $l->add($k, array(0 => 'ROLE_BABY'), NULL);
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('blackdevs911@gmail.com');
        $a->setPassword('fiorentina21838134');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Pidev\\FrontBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Pidev\\backBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Pidev\\UserBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Pidev\\MapBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Pidev\\GrapheBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Pidev\\FrontBundle/Resources/views'), 'PidevFront');
        $instance->addPath(($this->targetDirs[3].'\\src\\Pidev\\backBundle/Resources/views'), 'Pidevback');
        $instance->addPath(($this->targetDirs[3].'\\src\\Pidev\\UserBundle/Resources/views'), 'PidevUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\nomaya\\social-bundle\\Nomaya\\SocialBundle/Resources/views'), 'NomayaSocial');
        $instance->addPath(($this->targetDirs[3].'\\src\\Pidev\\MapBundle/Resources/views'), 'PidevMap');
        $instance->addPath(($this->targetDirs[3].'\\src\\Pidev\\GrapheBundle/Resources/views'), 'PidevGraphe');
    ...
    {
        return $this->services['validator'] = new \Symfony\Component\Validator\Validator($this->get('validator.mapping.class_metadata_factory'), new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('security.validator.user_password' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique')), $this->get('translator.default'), 'validators', array(0 => new \FOS\UserBundle\Validator\Initializer($this->get('fos_user.user_manager')), 1 => $this->get('doctrine.orm.validator_initializer')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PidevUserBundle' => 'Pidev\\UserBundle\\PidevUserBundle',
                ...
                'PidevMapBundle' => 'Pidev\\MapBundle\\PidevMapBundle',
                'PidevGrapheBundle' => 'Pidev\\GrapheBundle\\PidevGrapheBundle',
            ...
            'mailer_user' => 'blackdevs911@gmail.com',
            'mailer_password' => 'fiorentina21838134',
            'locale' => 'fr',
            ...
            'fos_user.model.user.class' => 'Pidev\\UserBundle\\Entity\\User',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'blackdevs911@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'fiorentina21838134',

...
class ServiceController extends Controller
{
     public function listServicesAction()
    {
        ...
        if($Request->getMethod()=='POST')
        {
            ...
            $services=$em->getRepository('PidevbackBundle:Service')->findByTypeService($typeService);
            return $this->render('PidevbackBundle:Service:listServices.html.twig', array('Services'=>$services));
        }
        //Fin Recherche
        
        //récupérer la liste de tous les produits
        $services=$em->getRepository('PidevbackBundle:Service')->findAll();
